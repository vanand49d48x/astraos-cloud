...
export default function DataSourcesDocsPage() {
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <CodeBlock
          code={`curl "https://www.astraos.cloud/api/v1/search?bbox=-122.5,37.5,-122.0,38.0&datetime=2025-01-01/2025-02-01&collections=sentinel-2-l2a&cloud_cover_lt=15" \\
  -H "Authorization: Bearer astra_sk_live_your_key_here"`}
      ...
      <section className="space-y-4">
        ...
        <CodeBlock
          code={`curl "https://www.astraos.cloud/api/v1/search?bbox=-122.5,37.5,-122.0,38.0&datetime=2025-01-01/2025-02-01&collections=landsat-c2-l2&cloud_cover_lt=20" \\
  -H "Authorization: Bearer astra_sk_live_your_key_here"`}
          language="bash"
